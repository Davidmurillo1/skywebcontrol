...
exports.getMostrarEquipos = async (req, res) => {
  try {
    ...
    const equipos = await Equipo.obtenerEquiposPorCategoria(
    ...
    for (let equipo of equipos) {
      const sumaTotalEquipos = await InstanciaEquipo.sumaTotalEquipos(
        equipo.id
      );
...
exports.postAgregarEquipo = async (req, res) => {
  try {
    ...
    if (req.file) {
      ...
      const directorioImagenes = path.join(
        __dirname,
        "..",
        "public",
        "img",
...
exports.getEditarEquipo = async (req, res) => {
  ...
  try {
    ...
    if (equipo) {
      ...
      res.redirect(`/equipo-detalle/${equipoId}`, {
        messages: req.flash(),
        equipo,
      });
    }
...
exports.getDetalleEquipo = async (req, res) => {
  ...
  try {
    ...
    res.render("detalleEquipo", {
      ...
      sumaTotalEquipos: sumaTotalEquipos,
    });
...
exports.postNuevaInstanciaEquipo = async (req, res) => {
  ...
  try {
    ...
    if (instanciaExistente) {
      ...
      req.flash(
        "error",
        "Ya existe una instancia del equipo con este número de registro para el equipo seleccionado."
      );
    ...
    console.log(
      "CATCH ERRORRRRRRRRRRRRRRRRRRRRRRRRR!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
    );
...
exports.postCrearCategoria = async (req, res) => {
  ...
  try {
    ...
    const crearCategoria = await CategoriaEquipo.crearNuevaCategoria(
      nombre,
      descripcion
    );
