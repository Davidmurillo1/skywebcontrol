...
router.post(
  ...
  equipoController.postAgregarEquipo
);
...
router.post(
  "/editar-imagen-equipo/:id",
  upload.single("file"),
  equipoController.postEditarImagenEquipo
);
...
router.post(
  "/editar-categoria/:categoriaId",
  equipoController.postEditarCategoria
);

// //INSTACIAS DE EQUIPO
router.get("/detalle-equipo/:id", equipoController.getDetalleEquipo);
router.get(
  "/registrar-instancia/:id",
  equipoController.getNuevaInstanciaEquipo
);
router.post(
  "/registrar-instancia/:id",
  equipoController.postNuevaInstanciaEquipo
);
